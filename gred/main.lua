...
Main.main = function() 
  ...
  while (not _G.ScreenShouldClose()) do 
    ...
    if (gridMgr:isEditing()) then 
      ...
      _G.DrawText(font, Std.string(Std.string("[F1] New -- [F2] Load -- [F3] Save -- [F4] Mode: ") .. Std.string(gridMgr:getModeName())) .. Std.string(" -- [ENTER] Preview"), 8, 8, -1);
      ...
      _G.DrawText(font, Std.string(Std.string(Std.string(Std.string("[U/I] Select flag number (current: ") .. Std.string(gridMgr:getCurrentFlag())) .. Std.string(") -- ")) .. Std.string("[P] Place flag -- ")) .. Std.string("[O] Delete flag"), 8, 40, -1);
